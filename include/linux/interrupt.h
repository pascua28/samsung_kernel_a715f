 ...
 * IRQF_LITTLE_AFFINE - Interrupt is not very critical to the overall performance of the
 *		      system and should be processed on a little CPU.
 */
...
#define IRQF_LITTLE_AFFINE	0x00400000
